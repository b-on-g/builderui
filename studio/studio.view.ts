...
`
	...
	export class $bog_builderui_studio extends $.$bog_builderui_studio {
		...
		async download_zip() {
			...
			const script = document.querySelector( 'script[src$="web.js"]' ) as HTMLScriptElement
			const base = new URL(
				new URL( script.src ).pathname.includes( '/studio/-/' ) ? '../../' : 'bog/builderui/',
				script.src,
			).href
